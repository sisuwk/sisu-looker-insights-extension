...
application: sisu-insights {
  ...
  entitlements: {
    use_embeds: yes
    use_form_submit: yes
    external_api_urls : ["http://localhost:6080", "http://localhost:8080","http://localhost:5000", "http://localhost:5005", "https://gcp-dev.sisu.ai", "https://app.sisu.ai"]
    ...
    new_window :  yes
    new_window_external_urls: ["http://localhost:6080/*"]
    oauth2_urls: ["https://authlib.org/", "https://localhost:6082/oauth/authorize", "https://gcp-dev.sisu.ai/oauth/authorize"]
  }
  mount_points: {
